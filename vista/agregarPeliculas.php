    ...
    <body>
        ...
        <div id="right-panel" class="right-panel">
            ...
            <div class="content mt-3">
                ...
                ?>
                <h1 style="text-align:center; font-size: 500%; font-weight: bold;">Agregar Peliculas</h1>
                <div class="col-2"></div>
                <div class="col-8 mt-5">
                    <form method="post" action="../controlador/agregarPelicula.php">
                        <input type="hidden" name="idUsuario" value="<?php echo $idUser ?>">
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Nombre de la Pelicula</label>
                            <input type="text" class="form-control" id="nombrePelicula" name="nombrePelicula" aria-describedby="emailHelp">
                        </div>
                        <div class="mb-3">
